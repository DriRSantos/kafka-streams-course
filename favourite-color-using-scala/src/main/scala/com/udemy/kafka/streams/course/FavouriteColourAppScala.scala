...
object FavouriteColourAppScala {
  def main(args: Array[String]): Unit = {
    ...
    config.put(StreamsConfig.BOOTSTRAP_SERVERS_CONFIG, "[::1]:9092")
    ...
    val textLines: KStream[String, String] = builder.stream[String, String]("favorite-colours-input")
    ...
    favouriteColours.toStream.to("favorite-colours-output-scala", Produced.`with`(stringSerde, longSerde))
