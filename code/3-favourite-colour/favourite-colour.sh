...
kafka-topics.sh --create --bootstrap-server [::1]:9092 --replication-factor 1 --partitions 1 --topic favorite-colours-input
...
kafka-topics.sh --create --bootstrap-server [::1]:9092 --replication-factor 1 --partitions 1 --topic user-keys-and-colours --config cleanup.policy=compact
...
kafka-topics.sh --create --bootstrap-server [::1]:9092 --replication-factor 1 --partitions 1 --topic favorite-colours-output --config cleanup.policy=compact
...
kafka-console-producer.sh --bootstrap-server [::1]:9092 --topic favorite-colours-input
#
stephane,blue
john,green
stephane,red
