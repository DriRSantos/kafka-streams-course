...
kafka-topics.sh --create --bootstrap-server [::1]:9092 --replication-factor 1 --partitions 3 --topic user-purchases
...
kafka-topics.sh --create --bootstrap-server [::1]:9092 --replication-factor 1 --partitions 2 --topic user-table --config cleanup.policy=compact
...
kafka-topics.sh --create --bootstrap-server [::1]:9092 --replication-factor 1 --partitions 3 --topic user-purchases-enriched-left-join
...
kafka-topics.sh --create --bootstrap-server [::1]:9092 --replication-factor 1 --partitions 3 --topic user-purchases-enriched-inner-join
